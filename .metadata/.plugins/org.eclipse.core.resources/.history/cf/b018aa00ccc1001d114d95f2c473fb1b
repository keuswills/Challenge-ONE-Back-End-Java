...
public class Conversor {
	...
	private static String[] choices1 = { "Conversor de Moedas", "Conversor de Temperatura" };

	private static String[] choices2 = { "Real para Dólar", "Real para Euro", "Real para Libras Esterlinas",
	...
	private static String[] choices3 = { "Celsius para Fahrenheit", "Fahrenheit para Celsius" };
	...
	public static void main(String[] args) {
		...
		if (choice1 == "Conversor de Moedas") {
			String choice2 = (String) JOptionPane.showInputDialog(null, "Qual conversão gostaria de fazer",
					"Conversor de Moedas e Temperaturas", JOptionPane.QUESTION_MESSAGE, null, choices2, choices2[0]);

			if (choice2 == "Real para Dólar") {
				String valor;
			...
			if (choice2 == "Real para Libras Esterlinas") {
				String valor;
				valor = JOptionPane.showInputDialog("Digite o valor em reais que você deseja converter:");
				double valorReal = Double.parseDouble(valor);
			...
			if (choice2 == "Real para Peso Argentino") {
				String valor;
				valor = JOptionPane.showInputDialog("Digite o valor em reais que você deseja converter:");
				double valorReal = Double.parseDouble(valor);
			...
			if (choice2 == "Real para Peso Chileno") {
				String valor;
				valor = JOptionPane.showInputDialog("Digite o valor em reais que você deseja converter:");
				double valorReal = Double.parseDouble(valor);
			...
			if (choice2 == "Libras Esterlinas para Real") {
				String valor;
			...
			if (choice2 == "Peso Argentino para Real") {
				String valor;
			...
			if (choice2 == "Peso Chileno para Real") {
				String valor;
			...
			String choice3 = (String) JOptionPane.showInputDialog(null, "Qual conversão gostaria de fazer?",
					"Conversor de Moedas e Temperaturas", JOptionPane.QUESTION_MESSAGE, null, choices3, choices3[0]);

			if (choice3 == "Celsius para Fahrenheit") {
				String valor;
			...
			if (choice3 == "Fahrenheit para Celsius") {
				String valor;
				valor = JOptionPane.showInputDialog("Digite o número em graus que você deseja converter:");
