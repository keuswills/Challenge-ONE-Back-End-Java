...
//	private static String getDialogChoices3() {
//		String[] choices = { "Conversor de Moedas", "Conversor de Temperatura" };
//		return (String) JOptionPane.showInputDialog(null, "Qual conversão deseja fazer?", "Conversor", JOptionPane.QUESTION_MESSAGE,
//				null, choices, choices[0]);
//	}

	private static String getDialogChoices() {
		String[] choices1 = { "Real para Dólar", "Real para Euro", "Real para Libras Esterlinas",
		...
		String[] choices2 = { "Celsius para Fahrenheit", "Fahrenheit para Celsius" };

		String[] choices3 = { "Conversor de Moedas", "Conversor de Temperatura" };

		return (String) JOptionPane.showInputDialog(null, "Qual tipo de conversor deseja utilizar?",
				"Conversor de Moedas e Temperaturas", JOptionPane.QUESTION_MESSAGE, null, choices3, choices3[0]);
	}

//	private static String getDialogChoices2() {
//		String[] choices = { "Celsius para Fahrenheit", "Fahrenheit para Celsius" };
//		return (String) JOptionPane.showInputDialog(null, "Qual conversão deseja fazer?", "Conversor de Temperatura",
//				JOptionPane.QUESTION_MESSAGE, null, choices, choices[0]);
//	}

//	private String[] choices2 = { "Celsius para Fahrenheit", "Fahrenheit para Celsius" };
//
//	private String[] choices1 = { "Real para Dólar", "Real para Euro", "Real para Libras Esterlinas",
//			"Real para Peso Argentino", "Real para Peso Chileno", "Dólar para Real", "Euro para Real",
//			"Libras Esterlinas para Real", "Peso Argentino para Real", "Peso Chileno para Real" };
//	
	public static void main(String[] args) {
//		String input3 = getDialogChoices3();
		String input = getDialogChoices();
//		String input2 = getDialogChoices2();

		if (input == "Conversor de Moedas") {
			...
			if (input == "Celsius para Fahrenheit") {
				String valor;
			...
			if (input == "Fahrenheit para Celsius") {
				String valor;
				valor = JOptionPane.showInputDialog("Digite o número em graus que você deseja converter:");
