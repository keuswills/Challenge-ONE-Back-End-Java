...
public class converteMoeda {	
	...
	private static String getDialogChoices() {
		String[] choices = {"Real para Dólar", "Real para Euro", "Real para Libras Esterlinas", "Real para Peso Argentino", "Real para Peso Chileno", "Dólar para Real", "Euro para Real", "Libras Esterlinas para Real", "Peso Argentino para Real", "Peso Chileno para Real"
				};
		return (String) JOptionPane.showInputDialog(null, "Qual conversão deseja fazer?", "Conversor de Moedas", JOptionPane.QUESTION_MESSAGE, null, choices, choices[0]);
	}
